...
const protoSigningClient = require("@cosmjs/proto-signing");
...
function addAccount() {
    (async () => {
        ...
        const addAccResult = await protoSigningClient.DirectSecp256k1HdWallet.generate(12,{});
        console.log(addAccResult);
